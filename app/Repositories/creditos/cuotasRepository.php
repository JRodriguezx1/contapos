...
class cuotasRepository extends operationRepository{
    ...
    public function obtenerPorCredito_cierracajaAbierto(int $id):array{
        $sql = "SELECT c.id_sucursal_idfk, c.id_credito, c.cierrecaja_id, c.valorpagado as cuotapagada, 
                c.fechapagado, cc.estado as estadoCierreCaja, cc.ventasenefectivo as ventasEfectivo_caja, cc.abonosseparados as abonosSeparados_caja,
                ...
                GROUP BY c.id_sucursal_idfk, c.id_credito, c.cierrecaja_id, c.valorpagado, c.fechapagado, cc.estado, cc.ventasenefectivo, cc.abonosseparados;";
        $rows = $this->fetchAllStd($sql);
