<div class="box solicitarinvnetario !pb-16">
    ...
    <div class="flex justify-between mt-6">
        <button id="btnAnteriorSolicitudInv" class="px-6 py-4 border rounded-lg hover:bg-gray-100 dark:border-neutral-700 dark:hover:bg-neutral-800">Anterior</button>
