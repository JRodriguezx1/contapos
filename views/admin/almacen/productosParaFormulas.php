<div class="box productosParaFormulas">
  ...
  <h4 class="text-gray-600 mb-12 mt-4">Gestionar formulas para productos de venta</h4>
  
  <table id="tablaproductosParaFormulas" class="display responsive nowrap tabla" width="100%">
      <thead>
          <tr>
              <th>Nº</th>
              <th>Producto</th>
      ...
      <tbody>
          <?php foreach($productos as $index => $value): ?>
            ...
            <tr class="fila producto" data-idproducto="<?php echo $value->id;?>" data-precio="<?php echo $value->precio_venta;?>"> 
                ...
                <td class=""><input
                                type="text" 
                                class="inputAjustarPrecio rounded-md px-3 py-1.5 text-xl text-gray-500 outline outline-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:outline-indigo-600" 
                                value="<?php echo $value->precio_venta;?>"
                                maxlength="10"
