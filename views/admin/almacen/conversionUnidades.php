<div class="box conversionUnidades !pb-20">
    ...
    <table id="tablaConversionUnidades" class="display responsive nowrap tabla" width="100%">
      <thead>
          <tr>
              <th>Nº</th>
              <th>ID</th>
    ...
    <dialog id="miDialogoConversionUnidad" class="w-[95%] max-w-xl p-8 rounded-2xl border border-slate-200 bg-white shadow-xl">
        ...
        <form id="formConversionUnidad" class="formulario" action="/admin/almacen/crear_ConversionUnidad" enctype="multipart/form-data" method="POST">
            <input type="hidden" id="idconversionUnidad" name="idunidad" value="">
            ...
            <div class="text-right mt-6">
                ...
                <input id="btnEditarConversionUnidadMedida" class="btn-md btn-indigo !mb-4 !py-4 px-6 !w-[100px]" type="submit" value="Crear">
            </div>
        </form>
