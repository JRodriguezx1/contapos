  ...
  <div class="h-full flex bg-gray-100 overflow-hidden">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      ...
      <header class="bg-indigo-600 text-white px-6 py-3 flex justify-between items-center flex-none rounded">
        ...
        <div class="text-base">Cajero: <strong>Julian Rodriguez</strong></div>
      </header>
  ...
  <div id="modalCobro" class="fixed inset-0 bg-black/50 hidden flex items-center justify-center z-50">
    <div class="bg-white w-full max-w-md md:max-w-2xl rounded-xl shadow-lg p-6">
      ...
      <div class="mb-4">
        ...
        <select id="medioPago" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg block w-full p-2.5 h-14 text-xl focus:outline-none focus:ring-1">
      ...
      <div id="bloqueEfectivo">
        <div class="mb-3">
          ...
          <input id="inputEfectivo" type="number" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg block w-full p-2.5 h-14 text-xl focus:outline-none focus:ring-1">
        </div>
