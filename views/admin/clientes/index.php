            ...
            <form id="formCrearUpdateCliente" class="formulario" action="/admin/clientes/crear" method="POST">
                ...
                <div class="formulario__campo">
                    ...
                    <div class="formulario__dato">
                        <input class="formulario__input bg-gray-50 border border-gray-300 text-gray-900 !rounded-lg focus:border-indigo-600 block w-full p-2.5     h-14 text-xl focus:outline-none focus:ring-1" type="text" placeholder="Nombre del cliente" id="nombre" name="nombre" value="<?php echo $crearcliente->nombre??'';?>" required>
                ...
                <div class="formulario__campo">
                    ...
                    <div class="formulario__dato">
                        <input class="formulario__input bg-gray-50 border border-gray-300 text-gray-900 !rounded-lg focus:border-indigo-600 block w-full p-2.5     h-14 text-xl focus:outline-none focus:ring-1" type="text" placeholder="Apellido del cliente" id="apellido" name="apellido" value="<?php echo $crearcliente->apellido??'';?>">
                        <!-- <label data-num="28" class="count-charts" for="">28</label> -->
                    </div>
                </div>
                <div class="formulario__campo">
                ...
                <div class="formulario__campo">
                    ...
                    <input class="formulario__input bg-gray-50 border border-gray-300 text-gray-900 !rounded-lg focus:border-indigo-600 block w-full p-2.5     h-14 text-xl focus:outline-none focus:ring-1" type="text" min="0" placeholder="Identificacion del cliente" id="identificacion" name="identificacion" value="<?php echo $crearcliente->identificacion??'';?>">
                </div>

                <div class="formulario__campo">
                    <label class="formulario__label" for="telefono">Teléfono</label>
                    <input class="formulario__input bg-gray-50 border border-gray-300 text-gray-900 !rounded-lg focus:border-indigo-600 block w-full p-2.5     h-14 text-xl focus:outline-none focus:ring-1" type="text" minlength="7" placeholder="telefono del cliente" id="telefono" name="telefono" value="<?php echo $crearcliente->telefono??'';?>" required>
                </div>
                ...
                <div class="formulario__campo">
                    ...
                    <input class="formulario__input bg-gray-50 border border-gray-300 text-gray-900 !rounded-lg focus:border-indigo-600 block w-full p-2.5     h-14 text-xl focus:outline-none focus:ring-1" type="date" placeholder="Fecha de nacimiento del cliente" id="fecha_nacimiento" name="fecha_nacimiento" value="<?php echo $crearcliente->fecha_nacimiento??'';?>">
                </div>
            ...
            <form id="formCrearUpdateDireccion" class="formulario" action="/admin/direcciones/crear" method="POST">
                ...
                <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 border-b border-gray-900/10 pb-10 mb-3">
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-2">
                            <select id="selectcliente" name="idcliente" class=" bg-gray-50 border border-gray-300 text-gray-900 !rounded-lg focus:border-indigo-600 block w-full p-2.5     h-14 text-xl focus:outline-none focus:ring-1" multiple="multiple" required>
                                <?php foreach($clientes as $cliente): ?>
                                    <?php if($cliente->id > 1){ ?>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="formulario__dato mt-2">
                            <input type="text" placeholder="Departamento o region" id="departamento" name="departamento" value="" class="bg-gray-50 border border-gray-300 text-gray-900 !rounded-lg focus:border-indigo-600 block w-full p-2.5     h-14 text-xl focus:outline-none focus:ring-1">
                            <!-- <label data-num="28" class="count-charts" for="">28</label> -->
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        <label class="formulario__label" for="ciudad">Ciudad</label>
                        <div class="formulario__dato mt-2">
                            <input type="text" placeholder="ciudad de residencia" id="ciudad" name="ciudad" value="" class="bg-gray-50 border border-gray-300 text-gray-900 !rounded-lg focus:border-indigo-600 block w-full p-2.5     h-14 text-xl focus:outline-none focus:ring-1">
                            <!-- <label data-num="28" class="count-charts" for="">28</label> -->
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="formulario__dato mt-2">
                            <input type="text" placeholder="direccion de vivienda" id="direccion" name="direccion" value="" class="bg-gray-50 border border-gray-300 text-gray-900 !rounded-lg focus:border-indigo-600 block w-full p-2.5     h-14 text-xl focus:outline-none focus:ring-1">
                ...
                <div class="text-right">
                    <button class="btn-md btn-turquoise !py-4 !px-6 !w-[136px]" type="button" value="salir">Salir</button>
                    <input id="btnEditarCrearDireccion" class="btn-md btn-indigo !mb-4 !py-4 px-6 !w-[136px]" type="submit" value="Crear">
                </div>
            </form>
            ...
            <form id="formUpDireccion" class="formulario" action="/admin/direccions/actualizar" method="POST">
                ...
                <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 border-b border-gray-900/10 pb-10 mb-3">
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-2">
                            <select id="selectdirecciones" name="direcciones" class="bg-gray-50 border border-gray-300 text-gray-900 !rounded-lg focus:border-indigo-600 block w-full p-2.5     h-14 text-xl focus:outline-none focus:ring-1" required>
                                <option value="" disabled selected>-Seleccionar-</option>
                    ...
                    <div class="sm:col-span-3">
                        <label class="formulario__label" for="tarifa">Tarifa</label>
                        <div class="mt-2">
                            <select id="uptarifa" name="tarifa" class="bg-gray-50 border border-gray-300 text-gray-900 !rounded-lg focus:border-indigo-600 block w-full p-2.5     h-14 text-xl focus:outline-none focus:ring-1" required>
                                <option value="" disabled selected>-Seleccionar-</option>
                                <?php foreach($tarifas as $tarifa): ?>
                                <option value="<?php echo $tarifa->id;?>"><?php echo $tarifa->nombre;?></option>
                                <?php endforeach; ?>
                    ...
                    <div class="sm:col-span-3">
                        <label class="formulario__label" for="departamento">Departamento</label>
                        <div class="formulario__dato mt-2">
                            <input type="text" placeholder="Departamento o region" id="updepartamento" name="departamento" value="" class="bg-gray-50 border border-gray-300 text-gray-900 !rounded-lg focus:border-indigo-600 block w-full p-2.5     h-14 text-xl focus:outline-none focus:ring-1">
                            <!-- <label data-num="28" class="count-charts" for="">28</label> -->
                        </div>
                    </div>
                    <div class="sm:col-span-3">
                        <label class="formulario__label" for="ciudad">Ciudad</label>
                        <div class="formulario__dato mt-2">
                            <input type="text" placeholder="ciudad de residencia" id="upciudad" name="ciudad" value="" class="bg-gray-50 border border-gray-300 text-gray-900 !rounded-lg focus:border-indigo-600 block w-full p-2.5     h-14 text-xl focus:outline-none focus:ring-1">
                            <!-- <label data-num="28" class="count-charts" for="">28</label> -->
                        </div>
                    </div>
                    <div class="sm:col-span-3">
                        <label class="formulario__label" for="direccion">Dirección</label>
                        <div class="formulario__dato mt-2">
                            <input type="text" placeholder="direccion de vivienda" id="updireccion" name="direccion" value="" class="bg-gray-50 border border-gray-300 text-gray-900 !rounded-lg focus:border-indigo-600 block w-full p-2.5     h-14 text-xl focus:outline-none focus:ring-1">
                            <!-- <label data-num="36" class="count-charts" for="">36</label> -->
                        </div>
                    </div>
                </div>
