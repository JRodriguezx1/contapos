<div class="box listaProductosComprados relative">
  ...
  <h4 class="text-gray-600 mb-8 mt-4">Lista de productos comprados</h4>
  ...
  <div class="mt-4">
    <table id="tablaProductosComprados" class="display responsive nowrap tabla" width="100%">
        <thead>
          <tr>
              <th>Usuario</th>
              <th>Proveedor</th>
