<div class="box creditosFinalizados">
  ...
  <h4 class="text-gray-600 mb-8 mt-4">Creditos finalizados</h4>

  <div class=" overflow-x-auto">   
        <table id="tablaCreditosFinalizados" class="display responsive nowrap tabla" width="100%">
            <thead>
                <tr>
                    <th>id</th>
                    <th>Fecha</th>
            ...
            <tbody>
                <?php foreach($creditosFinalizados as $index => $value):?>
                <tr> 
