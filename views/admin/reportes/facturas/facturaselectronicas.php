<div class="box facturaselectronicas relative">
  ...
  <h4 class="text-gray-600 mb-8 mt-4">Facturas electronicas</h4>
  ...
  <div class="mt-4">
    ...
    <table id="tablaFacturasElectronicas" class="display responsive nowrap tabla" width="100%"></table>
  </div>
</div>