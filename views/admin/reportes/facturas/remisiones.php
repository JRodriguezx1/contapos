<div class="box remisiones relative">
  ...
  <h4 class="text-gray-600 mb-8 mt-4">Remisiones</h4>
  ...
  <div class="mt-4">
        <table id="tablaRemisiones" class="display responsive nowrap tabla" width="100%">
            <thead>
                <tr>
                    <th>Id</th>
                    <th>Fecha</th>
