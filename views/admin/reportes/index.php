  ...
  <div class="w-full min-h-80 grid grid-cols-2 tlg:grid-cols-3 gap-4">
    ...
    <div class="tlg:row-start-2 tlg:row-end-3 col-start-1 col-end-3">
      ...
      <div class="flex flex-wrap gap-4 mb-4">
        <a href="/admin/reportes/ventasgenerales" class="flex flex-col items-center w-[120px] p-6 bg-gradient-to-br from-indigo-600 to-blue-500 hover:bg-gradient-to-bl !text-white text-center border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
          <span class="material-symbols-outlined">payments</span>Ventas generales
        </a>
        <a href="/admin/caja/ultimoscierres" class="flex flex-col items-center w-[120px] p-6 bg-gradient-to-br from-indigo-600 to-blue-500 hover:bg-gradient-to-bl !text-white text-center border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
          <span class="material-symbols-outlined">attach_money</span>Cierres de caja
        </a>
        <a href="/admin/caja/zetadiario" class="flex flex-col items-center w-[120px] p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 text-center text-slate-600">
          <i class="mb-1 text-3xl fa-solid fa-z"></i>Zeta diario
        </a>
        <a href="/admin/reportes/ventasxtransaccion" class="flex flex-col items-center w-[120px] p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 text-center text-slate-600">
          <span class="material-symbols-outlined">speaker_notes</span>Ventas por transaccion
        </a>
        <a href="/admin/reportes/ventasxcliente" class="flex flex-col items-center w-[120px] p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 text-center text-slate-600">
      ...
      <div class="flex flex-wrap gap-4 mb-4">
        <a href="/admin/reportes/inventarioxproducto" class="flex flex-col items-center w-[120px] p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 text-center text-slate-600">
