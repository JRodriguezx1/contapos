<div class="box utilidadRentabilidad relative">
  ...
  <h4 class="text-gray-600 mb-8 mt-4">Estadisticas, Utilidad y Rentabilidad</h4>
  ...
  <div class="flex flex-col lg:flex-row lg:items-center gap-4">
    ...
    <div class="flex items-center gap-3">
      <input 
        type="text" 
        name="datetimes" 
        class="bg-gray-50 border border-gray-300 text-gray-900 rounded-xl focus:border-indigo-600 block w-60 lg:w-80 p-3 text-base dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500"
