<div class="box">
    ...
    <div class="flex gap-4 mb-4">
        <a class="btn-command btn-command !text-white bg-gradient-to-br from-indigo-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2" href="/admin/caja/fechazetadiario?id=<?php echo $idultimocierreabierto; ?>"><span class="material-symbols-outlined">subject</span>Zeta diario de hoy</a>
