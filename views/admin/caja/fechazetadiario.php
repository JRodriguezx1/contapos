<div class="fechazetadiario relative bg-white p-12 rounded-lg shadow">
    ...
    <a href="/admin/caja/zetadiario" class="text-white bg-indigo-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-4 text-center inline-flex items-center me-2">
    ...
    <div class="mt-6 mb-20 flex justify-between flex-col gap-8 lg:flex-row md:gap-4 w-full lg:w-auto">
        <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 !rounded-lg focus:border-indigo-600 block w-auto p-2.5 h-14 text-xl focus:outline-none focus:ring-1" name="datetimes" />
        ...
        <div class="content-dropdawn w-auto">
            <div class="btnmultiselect bg-gray-50 border border-gray-300 text-gray-900 !rounded-lg focus:border-indigo-600 block w-full p-2.5 h-14 text-xl focus:outline-none focus:ring-1">
                <span class="btnmultiselect-text">Seleccionar Facturador</span>
                <span class="arrow !bg-indigo-600"><i class="fa-solid fa-chevron-down"></i></span>
            </div>
            <ul class="list-items z-10 hidden bg-white rounded-lg shadow-sm !mt-0 !pl-0 !pt-4 !pr-0 w-full !min-w-0">
        ...
        <button id="consultarZDiario" class="btn-md border border-gray-300 text-white !rounded-lg focus:border-indigo-600 block w-full p-2.5 h-14 text-xl focus:outline-none focus:ring-1 bg-indigo-600 hover:bg-indigo-800">Consultar</button>
    </div>

    <div class="flex flex-wrap gap-2 mb-6 pt-6 border-t-2 border-blue-600">
        <button class="btn-command !text-white bg-gradient-to-br from-indigo-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"><span class="material-symbols-outlined">print</span>Imprimir cierre</button>
