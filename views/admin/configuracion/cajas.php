<div class="gestioncajas">
  ...
  <h4 class="text-gray-600 mb-12 mt-4">Gestion de cajas facturadoras</h4>
  <button id="crearCaja" class="btn-md btn-blueintense !mb-4 !py-4 px-6 !bg-indigo-600">Crear caja</button>
