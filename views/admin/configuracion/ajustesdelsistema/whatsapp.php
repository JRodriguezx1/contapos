      ...
      <div class="bg-gray-50 p-5 rounded-xl border">
        ...
        <form class="space-y-4">
          ...
          <div>
            ...
            <input type="text"
              class="w-full mt-1 p-3 border rounded-lg focus:border-indigo-600 focus:ring-2 focus:ring-indigo-200 outline-none">
          </div>
          ...
          <button
            class="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-3 rounded-lg font-medium transition shadow">
            + Agregar destino
          </button>
