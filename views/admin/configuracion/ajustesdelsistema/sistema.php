<div class="contenido8 accordion_tab_content bg-white p-6 rounded-lg shadow-md w-full space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <!-- activar venta modo rapido -->
        <div class="flex flex-col gap-2">
            <label class="block text-xl font-medium text-gray-700 mb-1 mt-5 lg:mt-0">Activar el modo rapido de ventas</label>
            <label for="habilitar_venta_modo_rapido_si" class="flex items-center ps-4 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg cursor-pointer select-none w-full p-2.5 h-14 text-xl focus:border-indigo-600 focus:outline-none focus:ring-1    ">
            ...
            <label for="habilitar_venta_modo_rapido_no" class="flex items-center ps-4 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg cursor-pointer select-none w-full p-2.5 h-14 text-xl focus:border-indigo-600 focus:outline-none focus:ring-1    ">
        ...
        <div class="flex flex-col gap-2">
            ...
            <label for="habilitar_canal_de_venta_si" class="flex items-center ps-4 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg cursor-pointer select-none w-full p-2.5 h-14 text-xl focus:border-indigo-600 focus:outline-none focus:ring-1    ">
            ...
            <label for="habilitar_canal_de_venta_no" class="flex items-center ps-4 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg cursor-pointer select-none w-full p-2.5 h-14 text-xl focus:border-indigo-600 focus:outline-none focus:ring-1    ">
