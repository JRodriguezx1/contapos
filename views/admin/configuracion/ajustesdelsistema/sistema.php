<div class="contenido8 accordion_tab_content bg-white p-6 rounded-lg shadow-md w-full space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div class="flex flex-col gap-2">
            ...
            <label for="impresora_principal_de_CAJA_por_BT_si" class="flex items-center ps-4 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg select-none w-full p-2.5 h-14 text-xl focus:border-indigo-600 focus:outline-none focus:ring-1   cursor-pointer hover:border-indigo-500 ">
                <input id="impresora_principal_de_CAJA_por_BT_si" type="radio" name="impresora_principal_de_CAJA_por_BT" class="hidden peer" value="1" <?php echo $conflocal['impresora_principal_de_CAJA_por_BT']->valor_final == 1?'checked':'';?>>
                <div class="w-5 h-5 border-2 border-gray-300 rounded-full peer-checked:bg-indigo-600 peer-checked:border-indigo-600"></div>
                <span class="ms-3 text-xl font-medium text-gray-900">Si</span>
            </label>

            <label for="impresora_principal_de_CAJA_por_BT_no" class="flex items-center ps-4 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg select-none w-full p-2.5 h-14 text-xl focus:border-indigo-600 focus:outline-none focus:ring-1 cursor-pointer hover:border-indigo-500">
                <input id="impresora_principal_de_CAJA_por_BT_no" type="radio" name="impresora_principal_de_CAJA_por_BT" class="hidden peer" value="0" <?php echo $conflocal['impresora_principal_de_CAJA_por_BT']->valor_final == 0?'checked':'';?>>
                <div class="w-5 h-5 border-2 border-gray-300 rounded-full peer-checked:bg-indigo-600 peer-checked:border-indigo-600"></div>
                <span class="ms-3 text-xl font-medium text-gray-900">No</span>
            </label>
        </div>
