<div class="contenido5 accordion_tab_content bg-white p-6 rounded-lg shadow-md w-full space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 gap-y-10">
        ...
        <div>
        <label for="espaciado_papel" class="block text-xl font-medium text-gray-700 mb-1 mt-5 lg:mt-0">
            Espaciado de papel
        </label>
