<div class="contenido3 accordion_tab_content bg-white p-6 rounded-lg shadow-md w-full space-y-6 mt-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 gap-y-10">
        <div>
            <label for="clave_para_eliminar_factura" class="block mb-2 text-xl font-medium text-gray-900 dark:text-white">
        ...
        <div>
            <label for="clave_para_eliminar_un_gasto/base" class="block mb-2 text-xl font-medium text-gray-900 dark:text-white">
        ...
        <div>
            <label for="clave_para_agregar_descuento" class="block mb-2 text-xl font-medium text-gray-900 dark:text-white">
        ...
        <div>
            <label for="clave_para_abrir_cajón_monedero" class="block mb-2 text-xl font-medium text-gray-900 dark:text-white">
