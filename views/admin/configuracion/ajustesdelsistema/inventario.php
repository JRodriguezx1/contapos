<div class="configinventario contenido2 accordion_tab_content bg-white p-6 rounded-lg shadow-md w-full space-y-6 mt-6">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <label for="costopromedio" class="flex items-center ps-4 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg cursor-pointer select-none w-full p-2.5 h-14 text-xl focus:border-indigo-600 focus:outline-none focus:ring-1    ">
                            ...
                            <label for="ultimocosto" class="flex items-center ps-4 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg cursor-pointer select-none w-full p-2.5 h-14 text-xl focus:border-indigo-600 focus:outline-none focus:ring-1    ">
