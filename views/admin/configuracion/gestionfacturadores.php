<div class="gestionfacturadores">
  ...
  <button id="crearFacturador" class="btn-md btn-blueintense">Crear facturador</button>
  ...
  <dialog id="miDialogoFacturador" class="midialog-sm p-6 rounded-lg shadow-lg">
    ...
    <form id="formCrearUpdateFacturador" class="formulario" action="/admin/config/crear_facturador" method="POST">
            ...
            <div class="formulario__campo">
                ...
                <div class="formulario__dato">
                    <input class="formulario__input" type="text" placeholder="Nombre del facturador" id="nombrefacturador" name="nombre" value="" required>
            ...
            <div class="formulario__campo">
                ...
                <select class="formulario__select" id="idtipofacturador" name="idtipofacturador" required>
            ...
            <div class="formulario__campo">
                ...
                <div class="formulario__dato">
                    <input class="formulario__input" type="text" placeholder="Consecutivo inicial del consecutivo" id="rangoinicial" name="rangoinicial" value="" required>
                    <label data-num="42" class="count-charts" for="">42</label>
                </div>
            </div>
            <div class="formulario__campo">
                ...
                <div class="formulario__dato">
                    <input class="formulario__input" type="text" placeholder="Consecutivo final del consecutivo" id="rangofinal" name="rangofinal" value="" required>
                    <label data-num="42" class="count-charts" for="">42</label>
                </div>
            </div>
            <div class="formulario__campo">
                ...
                <div class="formulario__dato">
                    <input class="formulario__input" type="text" placeholder="Siguiente consecutivo" id="siguientevalor" name="siguientevalor" value="" required>
                    <label data-num="42" class="count-charts" for="">42</label>
                </div>
            </div>
            <div class="formulario__campo">
                <label class="formulario__label" for="fechainicio">Fecha inicio</label>
                <input class="formulario__input" type="date" placeholder="Siguiente consecutivo" id="fechainicio" name="fechainicio" value="" required>
            </div>
            <div class="formulario__campo">
                <label class="formulario__label" for="fechafin">Fecha fin</label>
                <input class="formulario__input" type="date" placeholder="Siguiente consecutivo" id="fechafin" name="fechafin" value="" required>
            </div>
            <div class="formulario__campo">
                <label class="formulario__label" for="resolucion">Numero de resolucion</label>
                <div class="formulario__dato">
                    <input class="formulario__input" type="text" placeholder="Numero de resolucion" id="resolucion" name="resolucion" value="" required>
                    <label data-num="42" class="count-charts" for="">42</label>
                </div>
            </div>
            <div class="formulario__campo">
                ...
                <div class="formulario__dato">
                    <input class="formulario__input" type="text" placeholder="Prefijo de la resolucion" id="prefijo" name="prefijo" value="" required>
                    <label data-num="42" class="count-charts" for="">42</label>
                </div>
            </div>
            <div class="formulario__campo">
                <label class="formulario__label" for="negociofacturador">Negocio</label>
                <select class="formulario__select" id="negociofacturador" name="negocio" required>
                    <option value="" disabled selected>-Seleccionar-</option>
        ...
        <div class="text-right">
            ...
            <input id="btnEditarCrearFacturador" class="btn-md btn-blue" type="submit" value="Crear">
        </div>
    </form>
