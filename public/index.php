...
$router->post('/admin/api/parametrosSistemalimiteDescuento', [parametroscontrolador::class, 'parametrosSistemalimiteDescuento']); //fetch llamado en configparametros.js
