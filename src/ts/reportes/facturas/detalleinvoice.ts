        ...
        if(idfeState == '2'){
          try {
              ...
              if(responseDian.exito !== undefined){
                ...
                if(filaDoc)filaDoc.children[3].children[1].innerHTML = `<div class="btn-xs btn-orange"> Aceptada NC </div>`;
                ...
                //actualizar tabla de detalle de documentos electronicos
                if(filaDoc)filaDoc.children[3].children[1].innerHTML = `<div class="btn-xs btn-red"> Error NC </div>`;
              }
          } catch (error) {
              console.log(error);
          }
